...
import u05lab.ex2.Conference.{ConferenceRev, ConferenceReviewing, Question}
...
class ConferenceReviewingTest:
  ...
  @Test
  def testAtLeastOneRelevanceScoreMoreThan(): Unit =
    assertEquals(cr.atLeastOneRelevanceScoreMoreEqualThan(8)(1), true)
    assertEquals(cr.atLeastOneRelevanceScoreMoreEqualThan(8)(2), true)
    assertEquals(cr.atLeastOneRelevanceScoreMoreEqualThan(8)(3), false)
    assertEquals(cr.atLeastOneRelevanceScoreMoreEqualThan(8)(4), true)
    assertEquals(cr.atLeastOneRelevanceScoreMoreEqualThan(8)(5), false)
  ...
  def testAverageWeightedFinalScore():Unit=
    assertEquals(cr.averageWeightedFinalScore(1),(4.8+5.4)/2,0.01)
    assertEquals(cr.averageWeightedFinalScore(2),(9.0+6.0)/2,0.01)
    assertEquals(cr.averageWeightedFinalScore(3),(0.9+1.6)/2,0.01)
    assertEquals(cr.averageWeightedFinalScore(4),(3.6+5.6+5.6)/3,0.01)
    assertEquals(cr.averageWeightedFinalScore(5),(6.0+7.0)/2,0.01)
  ...
  def optionalTestAverageWeightedFinalScore():Unit =
    ...
    assertEquals(cr.averageWeightedFinalScoreMap(),Map(1->(4.8+5.4)/2,2->(9.0+6.0)/2,3->(0.9+1.6)/2,4->(3.6+5.6+5.6)/3,5->(6.0+7.0)/2));
